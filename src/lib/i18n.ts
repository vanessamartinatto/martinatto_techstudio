...
const it = {
  ...
  footer: {
    ...
    blurb:
      "Da un'idea a un prodotto digitale funzionante, online in settimane, non mesi.",
...
const en: Dict = {
  ...
  footer: {
    ...
    blurb: "From idea to a working digital product — online in weeks, not months.",
    navTitle: "Navigation",
...
const pt: Dict = {
  ...
  footer: {
    ...
    blurb:
      "Da ideia a um produto digital funcional — online em semanas, não meses.",
    navTitle: "Navegação",
